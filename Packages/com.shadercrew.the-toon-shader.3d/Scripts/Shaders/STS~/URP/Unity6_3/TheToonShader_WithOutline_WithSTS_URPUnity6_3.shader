Shader "TheToonShader/URP/Unity6_3/TheToonShader_WithOutline_WithSTS"
{
   Properties
   {
...
#define NEED_FACING 1
            ...
            #include "Packages/com.shadercrew.the-toon-shader.3d/Scripts/Shaders/xxSharedTTSDependecies/ModifiedLightingFunctions/URP/LightingModifiedForToon6p3.hlsl"
        ...
        ShaderData CreateShaderData(SurfaceDescriptionInputs IN)
        {
         ...
         VertexToPixel Vert (VertexData v)
         {
          ...
          return o;
            ...
            GBufferFragOutput Frag (VertexToPixel IN
            #ifdef _DEPTHOFFSET_ON
              , out float outputDepth : SV_Depth
            #endif
            #if NEED_FACING
            ...
            ) 
            {
               ...
               return PackGBuffersBRDFData(brdfData, inputData, l.Smoothness, l.Emission + color, l.Occlusion);
            }
...
float3 ClipToWorldPos(float4 clipPos)
{
        ...
        float3 viewPos =  mul(unity_CameraInvProjection, float4(ndc * clipPos.w, clipPos.w)).xyz;
    #else
...
half4 frag(v2f i) : COLOR
{
    ...
    AddSeeThroughShaderToShader(albedo.xyz, emission, alphaForClipping, i.worldPos, i.worldNormal, i.screenPos);
