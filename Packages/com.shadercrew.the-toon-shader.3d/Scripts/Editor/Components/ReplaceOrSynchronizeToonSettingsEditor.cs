...
#region VARIABLES
        ...
        private SerializedProperty _StylingShadingThicknessMin;
        private SerializedProperty _StylingShadingControlMap;
        private SerializedProperty _StylingShadingUseControlMapThickness;
        private SerializedProperty _StylingShadingControlMapStrength;
        private SerializedProperty _StylingShadingEnableMappingPixelation;
        private SerializedProperty _StylingShadingMappingPixelSize;
        ...
        //DASHES:
        private SerializedProperty _StylingShadingEnableDashes;
        private SerializedProperty _StylingShadingDashesSize;
        private SerializedProperty _StylingShadingDashesUseHatchingDensity;
        private SerializedProperty _StylingShadingDashesDensity;
        private SerializedProperty _StylingShadingDashesType;
        private SerializedProperty _StylingShadingDashesRoundness;
        private SerializedProperty _StylingShadingDashesOffset;

        private SerializedProperty _StylingShadingDashesTransitionPosition;
        private SerializedProperty _StylingShadingDashesTransitionSoftness;
        ...
        private SerializedProperty _StylingCastShadowsEnableMappingPixelation;
        private SerializedProperty _StylingCastShadowsMappingPixelSize;
        ...
        //DASHES:
        private SerializedProperty _StylingCastShadowsEnableDashes;
        private SerializedProperty _StylingCastShadowsDashesSize;
        private SerializedProperty _StylingCastShadowsDashesUseHatchingDensity;
        private SerializedProperty _StylingCastShadowsDashesDensity;
        private SerializedProperty _StylingCastShadowsDashesRoundness;
        private SerializedProperty _StylingCastShadowsDashesType;
        private SerializedProperty _StylingCastShadowsDashesOffset;

        private SerializedProperty _StylingCastShadowsDashesTransitionPosition;
        private SerializedProperty _StylingCastShadowsDashesTransitionSoftness;
        ...
        private SerializedProperty _StylingSpecularShadingInteraction;
        ...
        private SerializedProperty _StylingSpecularEnableMappingPixelation;
        private SerializedProperty _StylingSpecularMappingPixelSize;
        //Density and Direction
        ...
        //DASHES:
        private SerializedProperty _StylingSpecularEnableDashes;
        private SerializedProperty _StylingSpecularDashesSize;
        private SerializedProperty _StylingSpecularDashesUseHatchingDensity;
        private SerializedProperty _StylingSpecularDashesDensity;
        private SerializedProperty _StylingSpecularDashesRoundness;
        private SerializedProperty _StylingSpecularDashesType;
        private SerializedProperty _StylingSpecularDashesOffset;

        private SerializedProperty _StylingSpecularDashesTransitionPosition;
        private SerializedProperty _StylingSpecularDashesTransitionSoftness;
        ...
        private SerializedProperty _StylingRimShadingInteraction;
        ...
        private SerializedProperty _StylingRimEnableMappingPixelation;
        private SerializedProperty _StylingRimMappingPixelSize;
        //Density and Direction
        ...
        //DASHES:
        private SerializedProperty _StylingRimEnableDashes;
        private SerializedProperty _StylingRimDashesSize;
        private SerializedProperty _StylingRimDashesUseHatchingDensity;
        private SerializedProperty _StylingRimDashesDensity;
        private SerializedProperty _StylingRimDashesRoundness;
        private SerializedProperty _StylingRimDashesType;
        private SerializedProperty _StylingRimDashesOffset;

        private SerializedProperty _StylingRimDashesTransitionPosition;
        private SerializedProperty _StylingRimDashesTransitionSoftness;
        ...
        private void OnEnable()
        {
            ...
            if (replaceOrSynchronizeToonSettings == null)
                return;
            ...
            foreach (string propertyName in ShaderUtils.ALL_PROPERITES)
            {
                FieldInfo field = GetType().GetField(propertyName, BindingFlags.Instance | BindingFlags.NonPublic);

                if (field == null)
                {
                    Debug.LogError($"Missing editor field for shader property: {propertyName}", target);
                    continue;
                }
                ...
                if (property == null)
                {
                    Debug.LogError($"Missing SerializedProperty on ReplaceOrSynchronizeToonSettings: {propertyName}", target);
                    continue;
                }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (methodMode == null || referenceMaterial == null || materialList == null)
            {
                EditorGUILayout.HelpBox("Inspector was not initialized correctly. Check missing serialized fields.", MessageType.Error);
                return;
            }   
        ...
        private void ShadingStyling()
        {
            ...
            DrawCategory(stylingShadingPartitioningProperties.ToArray(), stylingShadingPartitioning, "Tone Distribution", stylingShadingPartitioningFoldout);
            DrawCategory(stylingShadingBlendingProperties.ToArray(), stylingShadingBlending, "Compositing", stylingShadingBlendingFoldout);
            DrawCategory(stylingShadingDrawSpaceProperties.ToArray(), stylingShadingDrawSpace, "Mapping", stylingShadingDrawSpaceFoldout);
            DrawCategory(stylingShadingDensityAndRotationProperties.ToArray(), stylingShadingDensityAndRotation, "Pattern", stylingShadingDensityAndRotationFoldout);
            DrawCategory(stylingShadingStyleSettingsProperties.ToArray(), stylingShadingStyleSettings, "Mark Appearance", stylingShadingStyleSettingsFoldout);
            DrawCategory(stylingShadingRandomizeProperties.ToArray(), stylingShadingRandomize, "Variation", stylingShadingRandomizeFoldout);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            EditorGUILayout.Space();
        }
        ...
        private void CastShadowsStyling()
        {
            ...
            DrawCategory(stylingCastShadowsPartitioningProperties.ToArray(), stylingCastShadowsPartitioning, "Tone Distribution", stylingCastShadowsPartitioningFoldout);
            DrawCategory(stylingCastShadowsBlendingProperties.ToArray(), stylingCastShadowsBlending, "Compositing", stylingCastShadowsBlendingFoldout);
            DrawCategory(stylingCastShadowsDrawSpaceProperties.ToArray(), stylingCastShadowsDrawSpace, "Mapping", stylingCastShadowsDrawSpaceFoldout);
            DrawCategory(stylingCastShadowsDensityAndRotationProperties.ToArray(), stylingCastShadowsDensityAndRotation, "Pattern", stylingCastShadowsDensityAndRotationFoldout);
            DrawCategory(stylingCastShadowsStyleSettingsProperties.ToArray(), stylingCastShadowsStyleSettings, "Mark Appearance", stylingCastShadowsStyleSettingsFoldout);
            DrawCategory(stylingCastShadowsRandomizeProperties.ToArray(), stylingCastShadowsRandomize, "Variation", stylingCastShadowsRandomizeFoldout);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            EditorGUILayout.Space();
        }
        ...
        private void SpecularStyling()
        {
            ...
            DrawCategory(stylingSpecularBlendingProperties.ToArray(), stylingSpecularBlending, "Compositing", stylingSpecularBlendingFoldout);
            DrawCategory(stylingSpecularUVSpaceProperties.ToArray(), stylingSpecularDrawSpace, "Mapping", stylingSpecularDrawSpaceFoldout);
            DrawCategory(stylingSpecularDensityAndRotationProperties.ToArray(), stylingSpecularDensityAndRotation, "Pattern", stylingSpecularDensityAndRotationFoldout);
            DrawCategory(stylingSpecularStyleSettingsProperties.ToArray(), stylingSpecularStyleSettings, "Mark Appearance", stylingSpecularStyleSettingsFoldout);
            DrawCategory(stylingSpecularRandomizeProperties.ToArray(), stylingSpecularRandomize, "Variation", stylingSpecularRandomizeFoldout);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            EditorGUILayout.Space();
        ...
        private void RimStyling()
        {
            ...
            DrawCategory(stylingRimBlendingProperties.ToArray(), stylingRimBlending, "Compositing", stylingRimBlendingFoldout);
            DrawCategory(stylingRimUVSpaceProperties.ToArray(), stylingRimDrawSpace, "Mapping", stylingRimDrawSpaceFoldout);
            DrawCategory(stylingRimDensityAndRotationProperties.ToArray(), stylingRimDensityAndRotation, "Pattern", stylingRimDensityAndRotationFoldout);
            DrawCategory(stylingRimStyleSettingsProperties.ToArray(), stylingRimStyleSettings, "Mark Appearance", stylingRimStyleSettingsFoldout);
            DrawCategory(stylingRimRandomizeProperties.ToArray(), stylingRimRandomize, "Variation", stylingRimRandomizeFoldout);
        ...
        private void SetupStyleShadingPropertiesArrays()
        {
            ...
            stylingShadingStyleSettingsProperties = new List<SerializedProperty>() {    _StylingColor,
                                                                                        ...
                                                                                        _StylingShadingThicknessMin,
                                                                                        _StylingShadingControlMap,
                                                                                        _StylingShadingUseControlMapThickness,
                                                                                        _StylingShadingControlMapStrength,
                                                                                        _StylingShadingEnableMappingPixelation,
                                                                                        _StylingShadingMappingPixelSize,
                                                                                        ...
                                                                                        _StylingShadingDashesSize,
                                                                                        _StylingShadingDashesUseHatchingDensity,
                                                                                        _StylingShadingDashesDensity,
                                                                                        _StylingShadingDashesType,
                                                                                        _StylingShadingDashesRoundness,
                                                                                        _StylingShadingDashesOffset,
                                                                                        _StylingShadingDashesTransitionPosition,
                                                                                        _StylingShadingDashesTransitionSoftness};
        ...
        private void SetupStyleCastShadowsPropertiesArrays()
        {
            ...
            stylingCastShadowsDrawSpaceProperties = new List<SerializedProperty>() { _CastShadowsDrawSpace,
                                                                                ...
                                                                                _StylingCastShadowsEnableMappingPixelation,
                                                                                _StylingCastShadowsMappingPixelSize,};
            ...
            stylingCastShadowsStyleSettingsProperties = new List<SerializedProperty>() { 
                                                                                        ...
                                                                                        _StylingCastShadowsEnableDashes,
                                                                                        _StylingCastShadowsDashesSize,
                                                                                        _StylingCastShadowsDashesUseHatchingDensity,
                                                                                        _StylingCastShadowsDashesDensity,
                                                                                        _StylingCastShadowsDashesRoundness,
                                                                                        _StylingCastShadowsDashesType,
                                                                                        _StylingCastShadowsDashesOffset,
                                                                                        _StylingCastShadowsDashesTransitionPosition,
                                                                                        _StylingCastShadowsDashesTransitionSoftness};
        ...
        private void SetupStyleSpecularPropertiesArrays()
        {
            ...
            stylingSpecularSettingsProperties = new List<SerializedProperty>() {    _SyncWithSpecular,
                                                                                    ...
                                                                                    _StylingSpecularShadingInteraction};
            ...
            stylingSpecularUVSpaceProperties = new List<SerializedProperty>() { _SpecularDrawSpace,
                                                                                ...
                                                                                _StylingSpecularEnableMappingPixelation,
                                                                                _StylingSpecularMappingPixelSize,};
            ...
            stylingSpecularStyleSettingsProperties = new List<SerializedProperty>() {  
                                                                                        ...
                                                                                        _StylingSpecularEnableDashes,
                                                                                        _StylingSpecularDashesSize,
                                                                                        _StylingSpecularDashesUseHatchingDensity,
                                                                                        _StylingSpecularDashesDensity,
                                                                                        _StylingSpecularDashesRoundness,
                                                                                        _StylingSpecularDashesType,
                                                                                        _StylingSpecularDashesOffset,
                                                                                        _StylingSpecularDashesTransitionPosition,
        ...
        private void SetupStyleRimPropertiesArrays()
        {
            ...
            stylingRimUVSpaceProperties = new List<SerializedProperty>() { _RimDrawSpace,
                                                                                ...
                                                                                _RimPolarCenterMode,
                                                                                _RimPolarCenter,
                                                                                _StylingRimEnableMappingPixelation,
                                                                                _StylingRimMappingPixelSize};
            ...
            stylingRimStyleSettingsProperties = new List<SerializedProperty>() {
                                                                                        ...
                                                                                        _StylingRimDashesSize,
                                                                                        _StylingRimDashesUseHatchingDensity,
                                                                                        _StylingRimDashesDensity,
                                                                                        _StylingRimDashesRoundness,
                                                                                        _StylingRimDashesType,
                                                                                        _StylingRimDashesOffset,
                                                                                        _StylingRimDashesTransitionPosition,
                                                                                        _StylingRimDashesTransitionSoftness
        };
