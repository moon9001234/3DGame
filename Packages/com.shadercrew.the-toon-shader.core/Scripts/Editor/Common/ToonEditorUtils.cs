...
namespace ShaderCrew.TheToonShader
{
    public static class ToonEditorUtils
    {
        ...
        public static bool MakeTheToonShaderSubSubSectionHeaderWithFoldoutWithToggle(GUIContent guiContent, SavedBool foldoutBool, MaterialProperty toggle, int plusTextSize = 0)
        {
